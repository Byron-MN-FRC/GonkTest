...
=======
		...
		rightMaster = new WPI_TalonFX(1);
>>>>>>> 05c242b43c790a91c4ea0521ef8537d9b7a19cc7
...
<<<<<<< HEAD
	public void motorConfigTalon() {
		 ...
		 * Talon
		 */
		rightMaster.configRemoteFeedbackFilter(pigeon.getDeviceID(), RemoteSensorSource.Pigeon_Yaw, Constants.REMOTE_1,
	...
	// 	// Configure output and sensor direction
	// 	leftMaster.TalonFX.setInverted(_leftInvert);
	...
	// 	/* Configure the left Talon's selected sensor as integrated sensor */
	// 	// _leftConfig.primaryPID.selectedFeedbackSensor =
	...
	// 	 * the right Talon
	// 	 */
	// 	// _rightConfig.remoteFilter0.remoteSensorDeviceID = leftMaster.getDeviceID();
	// 	// // Device ID of Remote Source
	// 	// _rightConfig.remoteFilter0.remoteSensorSource =
