    ...
    private void config() {
     ...
     //   rightFollower.set(ControlMode.Follower, rightMaster.getDeviceID());
       ...
       // rightMaster.configMotionAcceleration(6000, Constants.kTimeoutMs);
        ...
        rightMaster.configRemoteFeedbackFilter(leftMaster.getDeviceID(), RemoteSensorSource.TalonSRX_SelectedSensor, Constants.REMOTE_0, Constants.kTimeoutMs);		

        /* Configure the Pigeon IMU to the other remote slot available on the right Talon */
        rightMaster.configRemoteFeedbackFilter(pigeon.getDeviceID(), RemoteSensorSource.Pigeon_Yaw, Constants.REMOTE_1,Constants.kTimeoutMs);
        ...
        rightMaster.configSensorTerm(SensorTerm.Sum1, FeedbackDevice.IntegratedSensor, Constants.kTimeoutMs);	// Integrated Encoder of current Talon

        /* Configure Sum [Sum of both Integrated Encoders] to be used for Primary PID Index */
        rightMaster.configSelectedFeedbackSensor(FeedbackDevice.SensorSum, Constants.PID_PRIMARY, Constants.kTimeoutMs);

        /* Scale Feedback by 0.5 to half the sum of Distance */
        rightMaster.configSelectedFeedbackCoefficient(0.5, Constants.PID_PRIMARY, Constants.kTimeoutMs);

        /* Configure Remote 1 [Pigeon IMU's Yaw] to be used for Auxiliary PID Index */
        rightMaster.configSelectedFeedbackSensor(FeedbackDevice.RemoteSensor1, Constants.PID_TURN, Constants.kTimeoutMs);
